...
#   # walltime: T <= 31 min, Mp <= 21 min, M up to ~83 min (SR CG iterations grow as M's QGT
#   # conditions badly: qgt 2 -> 22 s/step late in training); worst point ~135 min -> 2:30;
#   # ARMS=H -> --time=00:45:00, ARMS=Tp -> --time=00:50:00
